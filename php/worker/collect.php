<?php
	...
	?>
		...
		<script type="text/javascript">
			$("._Wish_L_M").css({"background": "red"}).html("<span class='pa'>!</span> Wishlist - <?php echo $w_list; ?>");
		</script>
	...
	<?php } else {
		...
		if ($_POST['_sRc'] == "wDb") {
			...
			<script type="text/javascript">
				$("._Wish_L_M").css({"background": "#ffc966"}).html("<span class='pa'>!</span> Wishlist - <?php echo $w_list; ?>");
			</script>
